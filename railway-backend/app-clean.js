...
console.log('🚀 ЗАПУСК CLEAN RAILWAY SERVER v26.0.0 - NO DEPENDENCIES!');
...
const server = http.createServer((req, res) => {
    ...
    if (url.pathname === '/' && req.method === 'GET') {
        ...
        res.end(JSON.stringify({
            status: 'OK',
            message: 'Railway Server CLEAN v26.0.0 - NO DEPENDENCIES!',
...
server.listen(PORT, () => {
    console.log(`🚀 Clean Railway Server запущен на порту ${PORT}`);
